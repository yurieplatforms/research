          ...
          <div className="flex items-center gap-2 px-3 py-3.5 rounded-full bg-[var(--bg-surface)] dark:bg-[#222222] max-w-4xl w-full">
            ...
            <div className="relative flex-1">
              <input
                ...
                className="flex-1 border-0 outline-0 focus:outline-none focus-visible:outline-none focus:ring-0 focus-visible:ring-0 rounded-md py-2 text-base bg-transparent w-full font-normal text-[var(--text-primary)] placeholder:text-[var(--text-secondary)]"
